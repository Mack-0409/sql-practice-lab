...
-- WAQTD EMPLOYEE NAME AND MANAGER HIREDATE IF EMPLOYEE WAS HIRED BEFORE 1982
SELECT E1.ENAME , E2.HIREDATE AS MGR_HIREDATE
FROM EMP E1, EMP E2
WHERE E1.MGR = E2.EMPNO AND E1.HIREDATE < '01-JAN-82';

-- WAQTD NAMES OF THE EMPLOYEE AND MANAGERS SALARY IF EMPLOYEE AND MANAGER BOTH EARN MORE THAN 2300.
SELECT E1.ENAME , E2.SAL AS MGR_SAL
FROM EMP E1, EMP E2
WHERE E1.MGR = E2.EMPNO AND E1.SAL > 2300 AND E2.SAL > 2300;

# TO JOIN MULTIPLE TABLE - We can join upto 256 tables. To join n numbers of tables we need to write (n-1) join condition.
